' SplitbyArc sample — demonstrates polygon splitting using line/arc geometry (VB.NET/.NET WinForms).
'
...
'   - Using TGIS_Topology.Split to divide polygon by line
...
'   TGIS_Topology.Split()       - polygon division operation
